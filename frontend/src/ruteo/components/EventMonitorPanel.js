...
const EventMonitorPanel = ({
  ...
  const safeTrafficEvents =
    normalizeEvents(trafficEvents);

  const safeEventHistory =
  ...
  return (
    <View style={localStyles.container}>
      ...
      <Text style={localStyles.description}>
        Simula marchas, bloqueos o
        trancaderas para demostrar el
        recálculo inteligente de rutas.
      </Text>

      {activeEvent && (
        <View
          style={[
            localStyles.activeEvent,
            {
              borderLeftColor:
                activeEvent.color ||
                "#F97316",
      ...
      {safeTrafficEvents.length > 0 ? (
        ...
        <View
          style={
            localStyles.emptyEventsContainer
          }
        >
          <Text
            style={
              localStyles.emptyEventsText
            }
          >
